# DevOps Training 2025 - IaC and DevOps Strategy

Base repository for infrastructure as code and the DevOps strategy used in the course.

## Course context
- Tools: Jenkins (on-prem), GitHub/GitLab (SaaS), and Azure DevOps (cloud 360 platform).
- This `feat/base` branch contains the minimum needed to start and the statements for all practices.
...
## Repository purpose
- Local provisioning of Jenkins and dependencies.
- Base material to configure pipelines and credentials.
- References and assets for the course CI/CD strategy.

## Practical cases (5)
There will be five practical cases, each with a single solution branch named `training-x-title`.
- training-1-jenkins-config (ONGOING) - statement: [training-1-jenkins-config.md](training-1-jenkins-config.md)
- training-2-piplines-ci-cd-jenkins (PENDING) - statement: [training-2-piplines-ci-cd-jenkins.md](training-2-piplines-ci-cd-jenkins.md)
